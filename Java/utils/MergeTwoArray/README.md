...
## Visual Walkthrough (matching current implementation)

Initial State:

```
arr1 = [1, 3, 5, 7, 0, 0, 0, 0]    array1LastIndex=3, sortedArrayLastIndex=7
arr2 = [2, 4, 6, 8]                array2LastIndex=3
```

Step 1: Compare `arr1[3]=7` vs `arr2[3]=8` → 8 is larger

```
arr1 = [1, 3, 5, 7, 0, 0, 0, 8]    array1LastIndex=3, array2LastIndex=2, sortedArrayLastIndex=6
```

Step 2: Compare `arr1[3]=7` vs `arr2[2]=6` → 7 is larger

```
arr1 = [1, 3, 5, 7, 0, 0, 7, 8]    array1LastIndex=2, array2LastIndex=2, sortedArrayLastIndex=5
```

Step 3: Compare `arr1[2]=5` vs `arr2[2]=6` → 6 is larger

```
arr1 = [1, 3, 5, 7, 0, 6, 7, 8]    array1LastIndex=2, array2LastIndex=1, sortedArrayLastIndex=4
```

Step 4: Compare `arr1[2]=5` vs `arr2[1]=4` → 5 is larger

```
arr1 = [1, 3, 5, 7, 5, 6, 7, 8]    array1LastIndex=1, array2LastIndex=1, sortedArrayLastIndex=3
```

Step 5: Compare `arr1[1]=3` vs `arr2[1]=4` → 4 is larger

```
arr1 = [1, 3, 5, 4, 5, 6, 7, 8]    array1LastIndex=1, array2LastIndex=0, sortedArrayLastIndex=2
```

Step 6: Compare `arr1[1]=3` vs `arr2[0]=2` → 3 is larger

```
arr1 = [1, 3, 3, 4, 5, 6, 7, 8]    array1LastIndex=0, array2LastIndex=0, sortedArrayLastIndex=1
```

Step 7: Compare `arr1[0]=1` vs `arr2[0]=2` → 2 is larger

```
arr1 = [1, 2, 3, 4, 5, 6, 7, 8]    array1LastIndex=0, array2LastIndex=-1, sortedArrayLastIndex=0
```

Loop ends (array2LastIndex < 0), `arr1` is fully merged.
